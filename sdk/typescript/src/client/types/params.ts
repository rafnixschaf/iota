...
export interface QueryEventsParams {
    /**
     * The event query criteria. See [Event filter](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/build/event_api#event-filters)
...
export interface SubscribeEventParams {
     ...
     * [Event filter](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/build/event_api#event-filters) documentation for examples.
     */
...
export interface UnsafeMoveCallParams {
     ...
     * [IotaJson](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/build/iota-json) format
     */
    arguments: unknown[];
    /**
     * gas object to be used in this transaction, node will pick one from the signer's possession if not
