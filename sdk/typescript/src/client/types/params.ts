...
export interface QueryEventsParams {
	/**
	 * The event query criteria. See [Event filter](https://wiki.iota.org/build/event_api#event-filters)
...
export interface SubscribeEventParams {
	 ...
	 * [Event filter](https://wiki.iota.org/build/event_api#event-filters) documentation for examples.
	 */
...
export interface UnsafeMoveCallParams {
	...
	/**
	 * the arguments to be passed into the Move function, in [IotaJson](https://wiki.iota.org/build/iota-json)
	 * format
	 */
	arguments: unknown[];
	/**
