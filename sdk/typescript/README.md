...
The SDK will be published to [npm registry](https://www.npmjs.com/package/@iota/iota) with the same
...
Note that the `latest` tag for the [published SDK](https://www.npmjs.com/package/@iota/iota) might
...
```bash
npm install @iota/iota@experimental
```
...
[current release of the SDK](https://www.npmjs.com/package/@iota/iota) at
...
```
pnpm --filter @iota/iota test:unit
```

To run E2E tests against local network

```
pnpm --filter @iota/iota prepare:e2e

// This will run all e2e tests
pnpm --filter @iota/iota test:e2e
...
```
VITE_FAUCET_URL='https://faucet.devnet.iota.io:443/gas' VITE_FULLNODE_URL='https://fullnode.devnet.iota.io' pnpm --filter @iota/iota exec vitest e2e
```
...
import { TransactionBlock } from '@iota/iota/transactions';
