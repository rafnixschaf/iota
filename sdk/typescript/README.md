...
The SDK will be published to [npm registry](https://www.npmjs.com/package/@mysten/iota.js) with the
...
Note that the `latest` tag for the [published SDK](https://www.npmjs.com/package/@mysten/iota.js)
...
```bash
npm install @mysten/iota.js@experimental
```
...
[current release of the SDK](https://www.npmjs.com/package/@mysten/iota.js) at
...
```
pnpm --filter @mysten/iota.js test:unit
```

To run E2E tests against local network

```
pnpm --filter @mysten/iota.js prepare:e2e

// This will run all e2e tests
pnpm --filter @mysten/iota.js test:e2e
...
```
VITE_FAUCET_URL='https://faucet.devnet.iota.io:443/gas' VITE_FULLNODE_URL='https://fullnode.devnet.iota.io' pnpm --filter @mysten/iota.js exec vitest e2e
```
