...
import { decodeIotaPrivateKey } from '../../src/cryptography';
...
describe('MultiSig with zklogin signature', () => {
    it('Execute tx with multisig with 1 sig and 1 zkLogin sig combined', async () => {
        // default ephemeral keypair, address_seed and zklogin inputs defined: https://github.com/iotaledger/iota/blob/071a2955f7dbb83ee01c35d3a4257926a50a35f5/crates/iota-types/src/unit_tests/zklogin_test_vectors.json
        ...
        let parsed = decodeIotaPrivateKey(
        ...
        let multisigAddr = multiSigPublicKey.toIotaAddress();
        ...
        const zkLoginInputs = {
            addressSeed:
                '2455937816256448139232531453880118833510874847675649348355284726183344259587',
