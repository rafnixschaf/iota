...
The majority of changes in this release are in the `@iota/iota-sdk` package, but the changes to API
...
## Changes to `@iota/iota-sdk`

As part of the 1.0 release the `@iota/iota-sdk.js` package has been renamed to `@iota/iota-sdk`

To upgrade to the new version, uninstall the old package and install the new one:

```sh npm2yarn
npm uninstall @iota/iota-sdk.js
...
```diff
- import { IotaClient } from '@iota/iota-sdk.js'
...
```diff
- import { Transactions } from '@iota/iota-sdk/transactions'
+ import { Commands } from '@iota/iota-sdk/transactions'
...
The `publicKeyFromIotaBytes` has been moved to `@iota/iota-sdk/verify`

```diff
- import { publicKeyFromIotaBytes } from '@iota/iota-sdk/multisig'
