...
The `@mysten/iota.js/bcs` package extends `@mysten/bcs` with Iota specific scheme definitions.

To learn more about using BCS see the [BCS documentation](/bcs).

the `bcs` export of `@mysten/iota.js/bcs` contains all the same exports as `bcs` from `@mysten/bcs`
