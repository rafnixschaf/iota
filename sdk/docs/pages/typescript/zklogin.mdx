...
```typescript
import { parseZkLoginSignature } '@mysten/iota.js/zklogin';
...
```typescript
import { getZkLoginSignature } '@mysten/iota.js/zklogin';
...
```typescript
import { computeZkLoginAddressFromSeed } '@mysten/iota.js/zklogin';
