...
```typescript
import { parseZkLoginSignature } '@iota/iota-sdk/zklogin';
...
```typescript
import { getZkLoginSignature } '@iota/iota-sdk/zklogin';
...
```typescript
import { computeZkLoginAddressFromSeed } '@iota/iota-sdk/zklogin';
