...
To establish a connection to a network, import `IotaClient` from `@mysten/iota.js/client` and pass the
...
[the Local Network guide](https://docs.iota.io/guides/developer/getting-started/local-network) for
more information.
...
[RPC documentation](https://docs.iota.io/references/iota-api).
