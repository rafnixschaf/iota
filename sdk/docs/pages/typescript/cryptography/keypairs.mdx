...
| --------------- | ------------------ | ----------------------------------- |
| Ed25519         | `Ed25519Keypair`   | `@mysten/iota.js/keypairs/ed25519`   |
| ECDSA Secp256k1 | `Secp256k1Keypair` | `@mysten/iota.js/keypairs/secp256k1` |
| ECDSA Secp256r1 | `Secp256r1Keypair` | `@mysten/iota.js/keypairs/secp256r1` |

For information on these schemes, see the
[Signatures](https://docs.iota.io/concepts/cryptography/transaction-auth/signatures) topic.

To use, import the key pair class your project uses from the `@mysten/iota.js/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@mysten/iota.js/keypairs/ed25519`.
...
```typescript
import { Ed25519Keypair, Ed25519PublicKey } from '@mysten/iota.js/keypairs/ed25519';
...
```typescript
import { Ed25519Keypair } from '@mysten/iota.js/keypairs/ed25519';
import { verifyPersonalMessage } from '@mysten/iota.js/verify';
...
import { Ed25519Keypair } from '@mysten/iota.js/keypairs/ed25519';
import { verifyTransactionBlock } from '@mysten/iota.js/verify';
...
```typescript
import { Ed25519Keypair } from '@mysten/iota.js/keypairs/ed25519';
import { fromHex } from '@mysten/iota.js/utils';
