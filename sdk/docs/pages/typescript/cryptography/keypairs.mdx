...
| --------------- | ------------------ | ------------------------------- |
| Ed25519         | `Ed25519Keypair`   | `@iota/iota/keypairs/ed25519`   |
| ECDSA Secp256k1 | `Secp256k1Keypair` | `@iota/iota/keypairs/secp256k1` |
| ECDSA Secp256r1 | `Secp256r1Keypair` | `@iota/iota/keypairs/secp256r1` |

For information on these schemes, see the
[Signatures](https://wiki.iota.org/concepts/cryptography/transaction-auth/signatures) topic.

To use, import the key pair class your project uses from the `@iota/iota/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@iota/iota/keypairs/ed25519`.
...
to retrieve its associated Iota address. You can access a `Keypair` from its `PublicKey` or
construct it from the bytes (as a `Uint8Array`) of the `PublicKey`, as in the following code:
...
```typescript
import { Ed25519Keypair } from '@iota/iota/keypairs/ed25519';
import { verifyPersonalMessageSignature } from '@iota/iota/verify';
...
import { Ed25519Keypair } from '@iota/iota/keypairs/ed25519';
import { verifyTransactionSignature } from '@iota/iota/verify';
...
```typescript
import { decodeIotaPrivateKey, encodeIotaPrivateKey } from '@iota/iota/cryptography';
import { Ed25519Keypair } from '@iota/iota/keypairs/ed25519';
...
```typescript
import { Ed25519Keypair } from '@iota/iota/keypairs/ed25519';
import { fromHex } from '@iota/iota/utils';
