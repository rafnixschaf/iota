...
endpoints maintained by IOTA Foundation (`fullnode.<NETWORK>.iota.io:443`) are rate-limited, and support
...
for IOTA on the [IOTA Dev Portal](https://iota.org/developers#dev-tools) using the **Node Service** tab.
...
- `Connection` classes - The `Connection` classes (`Connection`, `devnetConnection`, and so on) have
  been deprecated in favor of using `iotaClient` for establishing the connection. See
  [Network Interactions with IotaClient](typescript/iota-client) for more information.
- The `superstruct` type definitions for `JsonRPCProvider` types are replaced with generated types
  exported from `@iota/iota-sdk/client`. The new type definitions are pure TypeScript types that you
...
`@iota/iota-sdk/faucet`. The `@iota/iota-sdk/faucet` import also provides a `getFaucetHost` method to
...
- [`@iota/iota-sdk/client`](/typescript/iota-client) - A client for interacting with IOTA RPC nodes.
- [`@iota/iota-sdk/bcs`](/typescript/bcs) - A BCS builder with pre-defined types for IOTA.
- [`@iota/iota-sdk/transactions`](/typescript/transaction-building/basics) - Utilities for building and
  interacting with transactions.
- [`@iota/iota-sdk/keypairs/*`](/typescript/cryptography/keypairs) - Modular exports for specific
  KeyPair implementations.
- [`@iota/iota-sdk/verify`](/typescript/cryptography/keypairs#verifying-signatures-without-a-key-pair) -
  Methods for verifying transactions and messages.
- [`@iota/iota-sdk/cryptography`](/typescript/cryptography/keypairs) - Shared types and classes for
  cryptography.
- [`@iota/iota-sdk/multisig`](/typescript/cryptography/multisig) - Utilities for working with multisig
  signatures.
- [`@iota/iota-sdk/utils`](/typescript/utils) - Utilities for formatting and parsing various IOTA types.
- [`@iota/iota-sdk/faucet`](/typescript/faucet) - Methods for requesting IOTA from a faucet.
- [`@iota/iota-sdk/zklogin`](/typescript/zklogin) - Utilities for working with zkLogin. (Note
