...
- The `superstruct` type definitions for `JsonRPCProvider` types are replaced with generated types
  exported from `@mysten/iota.js/client`. The new type definitions are pure TypeScript types that you
...
`@mysten/iota.js/faucet`. The `@mysten/iota.js/faucet` import also provides a `getFaucetHost` method
...
- [`@mysten/iota.js/client`](/typescript/iota-client) - A client for interacting with Iota RPC nodes.
- [`@mysten/iota.js/bcs`](/typescript/bcs) - A BCS builder with pre-defined types for Iota.
- [`@mysten/iota.js/transaction`](/typescript/transaction-building/basics) - Utilities for building
  and interacting with transactions.
- [`@mysten/iota.js/keypairs/*`](/typescript/cryptography/keypairs) - Modular exports for specific
  KeyPair implementations.
- [`@mysten/iota.js/verify`](/typescript/cryptography/keypairs#verifying-signatures-without-a-key-pair) -
  Methods for verifying transactions and messages.
- [`@mysten/iota.js/cryptography`](/typescript/cryptography/keypairs) - Shared types and classes for
  cryptography.
- [`@mysten/iota.js/multisig`](/typescript/cryptography/multisig) - Utilities for working with
  multisig signatures.
- [`@mysten/iota.js/utils`](/typescript/utils) - Utilities for formatting and parsing various Iota
  types.
- [`@mysten/iota.js/faucet`](/typescript/faucet) - Methods for requesting IOTA from a faucet.
- [`@mysten/iota.js/zklogin`](/typescript/zklogin) - Utilities for working with zkLogin. (Note
