...
This approach works well for IOTA, but can't be used for other coin types. The CoinWithBalance
...
```typescript
import { coinWithBalance, Transaction } from '@iota/iota/transactions';
