...
an address, use the [Iota Client CLI](https://wiki.iota.org/references/cli/client) or the
...
You can also use the [Iota Client CLI](https://wiki.iota.org/references/cli/client) to perform client
