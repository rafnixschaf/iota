...
[gas smashing](https://wiki.iota.org/concepts/transactions/gas-smashing) and the IOTA TypeScript SDK's
...
[use a faucet](https://wiki.iota.org/guides/developer/getting-started/get-coins) to mint some.
