...
[gas smashing](https://docs.iota.io/concepts/transactions/gas-smashing) and the Iota TypeScript SDK's
...
As an example, assume that you need to execute 10 transactions that transfer 100 MICROS each to a
fixed recipient.
...
[use a faucet](https://docs.iota.io/guides/developer/getting-started/get-coins) to mint some.
