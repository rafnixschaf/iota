...
`0x2::coin::Coin<0x2::iota::IOTA>`) from the `mainPool` that their sum of balances surpasses a
...
[`splitStrategies.ts` file](https://github.com/iotaledger/Iota_Owned_Object_Pools/blob/main/src/splitStrategies.ts).
