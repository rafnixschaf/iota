...
describe('formatBalance', () => {
	...
	it('formats integer amounts with full CoinFormat', () => {
		...
		expect(formatBalance(toMicros('9999.9999'), IOTA_DECIMALS, CoinFormat.FULL)).toEqual('9,999.9999');
		...
		expect(formatBalance(toMicros('1234000'), IOTA_DECIMALS, CoinFormat.FULL)).toEqual('1,234,000');
