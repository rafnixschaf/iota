export const developmentFeatures = {
      ...
      },
      {
        ...
        force: [
          ...
          },
          {
            name: 'Clutchy',
            description:
              'Gaming and NFT marketplace for creators and communities',
  ...
  'kiosk-originbyte-packageid': {
    defaultValue:
      '0x2678c98fe23173eebea384509464eb81b1f3035a57419cb46d025000c337451a',
  },
  'wallet-apps-banner-config': {
    defaultValue: {
      ...
      imageUrl:
        'https://fe-assets.mystenlabs.com/wallet-next/suiwallet-mobile.svg',
    },
    rules: [
      {
        condition: {
  ...
  'wallet-interstitial-config': {
    defaultValue: {
      ...
      imageUrl:
        'https://fe-assets.mystenlabs.com/quests/winter-apps-interstitial.svg',
  ...
  'suins-front-page-banner': {
    defaultValue: {
      ...
      imageUrl:
        'https://fe-assets.mystenlabs.com/quests_3_updated_large_corrected.svg',
