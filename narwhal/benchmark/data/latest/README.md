...
This folder contains some raw data and plots obtained running a geo-replicated benchmark on AWS as explained in the [benchmark's readme file](https://github.com/iotaledger/kinesis/blob/main/narwhal/benchmark/README.md). The results are taken running the code tagged as [v0.2.0](https://github.com/asonnino/narwhal/tree/v0.2.0).
...
### Experimental step
The content of our [settings.json](https://github.com/iotaledger/kinesis/blob/main/narwhal/benchmark/settings.json) file looks as follows:
```json
{
    "key": {
        "name": "aws",
...
```
We set the following `node_params` in our [fabfile](https://github.com/iotaledger/kinesis/blob/main/narwhal/benchmark/fabfile.py):
```python
node_params = {
