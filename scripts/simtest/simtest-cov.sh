...
MSIM_WATCHDOG_TIMEOUT_MS=60000 MSIM_TEST_SEED=1 cargo llvm-cov --workspace --ignore-run-fail --no-report nextest -vv --cargo-profile simulator

echo "Checking validity of generated .profraw files."
