...
MSIM_WATCHDOG_TIMEOUT_MS=60000 MSIM_TEST_SEED=1 cargo llvm-cov --jobs 1 --ignore-run-fail --lcov --output-path lcov-simtest.info nextest --cargo-profile simulator
