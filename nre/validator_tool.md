...
1. Make sure you have completed all the [prerequisites](https://docs.iota.org/developer/getting-started/install-iota).
...
3. Run the following command to set up your Iota account and CLI environment.
   ...
   If at this point you can't find where `client.yaml` or `iota.keystore` is or have other questions, read [Iota Client CLI tutorial](https://docs.iota.org/developer/getting-started/connect).
