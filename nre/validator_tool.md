...
1. Make sure you have completed all the [prerequisites](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/devnet/build/install).
...
3. Run the following command to set up your Iota account and CLI environment.
   ...
   If at this point you can't find where `client.yaml` or `iota.keystore` is or have other questions, read [Iota Client CLI tutorial](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/devnet/build/cli-client).
