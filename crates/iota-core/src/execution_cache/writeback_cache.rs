...
impl ExecutionCacheRead for WritebackCache {
    ...
    fn _get_latest_lock_for_object_id(&self, _object_id: ObjectID) -> IotaResult<ObjectRef> {
        todo!()
    }

    fn check_owned_object_locks_exist(&self, _owned_object_refs: &[ObjectRef]) -> IotaResult {
        todo!()
    }
}
