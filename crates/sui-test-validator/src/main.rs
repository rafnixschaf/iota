...
struct Args {
    ...
    /// keystore sui genesis -f --with-faucet generates a genesis config
    /// that can be used to start this process. Example: sui-test-validator
    /// --config-dir ~/.sui/sui_config We can use any config dir that is
    /// generated by the sui genesis.
    #[clap(short, long)]
