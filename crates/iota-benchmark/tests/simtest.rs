...
mod test {
    ...
    use iota_config::{genesis::Genesis, AUTHORITIES_DB_NAME, IOTA_KEYSTORE_FILENAME};
    use iota_core::{
        authority::{
    ...
    impl TestInitData {
        pub async fn new(test_cluster: &TestCluster) -> Self {
            ...
            Self {
                keystore_path: test_cluster.swarm.dir().join(IOTA_KEYSTORE_FILENAME),
