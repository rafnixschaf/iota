...
pub struct ProtocolConfig {
    ...
    /// Maximum number of gas units that a single MoveCall transaction can use. Enforced by the Iota adapter.
    max_tx_gas: Option<u64>,

    /// Maximum amount of the proposed gas price in MICROS (defined in the transaction).
