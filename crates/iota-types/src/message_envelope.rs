...
impl<T: Message + AuthenticatedMessage> Envelope<T, EmptySignInfo> {
    pub fn verify_signature(&self, verify_params: &VerifyParams) -> IotaResult {
    ...
    ) -> IotaResult<VerifiedEnvelope<T, EmptySignInfo>> {
    ...
    T: Message + Serialize,
{
        ...
        <T as Message>::DigestType: PartialEq,
    {
        ...
        self.auth_signature
            .verify_secure(self.data(), Intent::iota_app(T::SCOPE), committee)
    }
}
    ...
    T: Message + AuthenticatedMessage + Serialize,
{
    ...
    pub fn verify_authenticated(
        ...
        committee: &Committee,
        verify_params: &VerifyParams,
    ) -> IotaResult<VerifiedEnvelope<T, AuthoritySignInfo>> {
    ...
    T: Message + AuthenticatedMessage + Serialize,
{
    ...
    pub fn verify_authenticated(
        ...
        committee: &Committee,
        verify_params: &VerifyParams,
    ) -> IotaResult<VerifiedEnvelope<T, AuthorityQuorumSignInfo<S>>> {
        self.verify_signatures_authenticated(committee, verify_params)?;
