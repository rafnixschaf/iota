...
use sui_types::base_types::{ObjectID, ObjectInfo, ObjectRef, SequenceNumber, SuiAddress};
...
pub trait StateRead: Send + Sync {
    ...
    async fn get_balance(&self, owner: SuiAddress, coin_type: TypeTag) -> StateReadResult<u128>;
    async fn get_all_balance(
        &self,
        owner: SuiAddress,
    ) -> StateReadResult<Arc<HashMap<TypeTag, u128>>>;
