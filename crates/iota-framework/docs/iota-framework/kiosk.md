...
<dt>
<code>profits: <a href="balance.md#0x2_balance_Balance">balance::Balance</a>&lt;<a href="iota.md#0x2_iota_IOTA">iota::IOTA</a>&gt;</code>
</dt>
<dd>
...
<pre><code>entry <b>fun</b> <a href="kiosk.md#0x2_kiosk_default">default</a>(ctx: &<b>mut</b> TxContext) {
    ...
    iota::transfer::share_object(<a href="kiosk.md#0x2_kiosk">kiosk</a>);
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="kiosk.md#0x2_kiosk_purchase">purchase</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="kiosk.md#0x2_kiosk_Kiosk">Kiosk</a>, id: ID, payment: Coin&lt;IOTA&gt;
): (T, TransferRequest&lt;T&gt;) {
...
<pre><code><b>public</b> <b>fun</b> <a href="kiosk.md#0x2_kiosk_purchase_with_cap">purchase_with_cap</a>&lt;T: key + store&gt;(
    self: &<b>mut</b> <a href="kiosk.md#0x2_kiosk_Kiosk">Kiosk</a>, purchase_cap: <a href="kiosk.md#0x2_kiosk_PurchaseCap">PurchaseCap</a>&lt;T&gt;, payment: Coin&lt;IOTA&gt;
): (T, TransferRequest&lt;T&gt;) {
...
<pre><code><b>public</b> <b>fun</b> <a href="kiosk.md#0x2_kiosk_profits_mut">profits_mut</a>(self: &<b>mut</b> <a href="kiosk.md#0x2_kiosk_Kiosk">Kiosk</a>, cap: &<a href="kiosk.md#0x2_kiosk_KioskOwnerCap">KioskOwnerCap</a>): &<b>mut</b> Balance&lt;IOTA&gt; {
    <b>assert</b>!(self.<a href="kiosk.md#0x2_kiosk_has_access">has_access</a>(cap), <a href="kiosk.md#0x2_kiosk_ENotOwner">ENotOwner</a>);
