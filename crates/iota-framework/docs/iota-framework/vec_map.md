...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/vec_map.md#0x2_vec_map_from_keys_values">from_keys_values</a>&lt;K: <b>copy</b>, V&gt;(
...
): <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">VecMap</a>&lt;K, V&gt; {
    ...
    <b>while</b> (!keys.<a href="../iota-framework/vec_map.md#0x2_vec_map_is_empty">is_empty</a>()) map.<a href="../iota-framework/vec_map.md#0x2_vec_map_insert">insert</a>(keys.pop_back(), values.pop_back());
