...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_to_bytes">id_to_bytes</a>(id: &<a href="../iota-framework/object.md#0x2_object_ID">ID</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_to_address">id_to_address</a>(id: &<a href="../iota-framework/object.md#0x2_object_ID">ID</a>): <b>address</b> {
    id.bytes
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_from_bytes">id_from_bytes</a>(bytes: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;): <a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_from_address">id_from_address</a>(bytes: <b>address</b>): <a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
    <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../iota-framework/object.md#0x2_object_iota_system_state">iota_system_state</a>(ctx: &TxContext): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <b>assert</b>!(ctx.sender() == @0x0, <a href="../iota-framework/object.md#0x2_object_ENotSystemAddress">ENotSystemAddress</a>);
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_SYSTEM_STATE_OBJECT_ID">IOTA_SYSTEM_STATE_OBJECT_ID</a> },
    }
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../iota-framework/clock.md#0x2_clock">clock</a>(): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_CLOCK_OBJECT_ID">IOTA_CLOCK_OBJECT_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../iota-framework/authenticator_state.md#0x2_authenticator_state">authenticator_state</a>(): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_AUTHENTICATOR_STATE_ID">IOTA_AUTHENTICATOR_STATE_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../iota-framework/object.md#0x2_object_randomness_state">randomness_state</a>(): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_RANDOM_ID">IOTA_RANDOM_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../iota-framework/object.md#0x2_object_iota_deny_list_object_id">iota_deny_list_object_id</a>(): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_DENY_LIST_OBJECT_ID">IOTA_DENY_LIST_OBJECT_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>fun</b> <a href="../iota-framework/object.md#0x2_object_bridge">bridge</a>(): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: <a href="../iota-framework/object.md#0x2_object_IOTA_BRIDGE_ID">IOTA_BRIDGE_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_uid_as_inner">uid_as_inner</a>(uid: &<a href="../iota-framework/object.md#0x2_object_UID">UID</a>): &<a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
    &uid.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_uid_to_inner">uid_to_inner</a>(uid: &<a href="../iota-framework/object.md#0x2_object_UID">UID</a>): <a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
    uid.id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_uid_to_bytes">uid_to_bytes</a>(uid: &<a href="../iota-framework/object.md#0x2_object_UID">UID</a>): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_uid_to_address">uid_to_address</a>(uid: &<a href="../iota-framework/object.md#0x2_object_UID">UID</a>): <b>address</b> {
    uid.id.bytes
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_new">new</a>(ctx: &<b>mut</b> TxContext): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
        id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes: ctx.fresh_object_address() },
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_delete">delete</a>(id: <a href="../iota-framework/object.md#0x2_object_UID">UID</a>) {
    <b>let</b> <a href="../iota-framework/object.md#0x2_object_UID">UID</a> { id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes } } = id;
    <a href="../iota-framework/object.md#0x2_object_delete_impl">delete_impl</a>(bytes)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id">id</a>&lt;T: key&gt;(obj: &T): <a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
    <a href="../iota-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_borrow_id">borrow_id</a>&lt;T: key&gt;(obj: &T): &<a href="../iota-framework/object.md#0x2_object_ID">ID</a> {
    &<a href="../iota-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_bytes">id_bytes</a>&lt;T: key&gt;(obj: &T): <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <a href="../move-stdlib/bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&<a href="../iota-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_id_address">id_address</a>&lt;T: key&gt;(obj: &T): <b>address</b> {
    <a href="../iota-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id.bytes
}
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_borrow_uid">borrow_uid</a>&lt;T: key&gt;(obj: &T): &<a href="../iota-framework/object.md#0x2_object_UID">UID</a>;
</code></pre>
...
<pre><code><b>public</b>(package) <b>fun</b> <a href="../iota-framework/object.md#0x2_object_new_uid_from_hash">new_uid_from_hash</a>(bytes: <b>address</b>): <a href="../iota-framework/object.md#0x2_object_UID">UID</a> {
    <a href="../iota-framework/object.md#0x2_object_record_new_uid">record_new_uid</a>(bytes);
    <a href="../iota-framework/object.md#0x2_object_UID">UID</a> { id: <a href="../iota-framework/object.md#0x2_object_ID">ID</a> { bytes } }
}
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_delete_impl">delete_impl</a>(id: <b>address</b>);
</code></pre>
...
<pre><code><b>native</b> <b>fun</b> <a href="../iota-framework/object.md#0x2_object_record_new_uid">record_new_uid</a>(id: <b>address</b>);
</code></pre>
