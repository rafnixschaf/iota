...
<pre><code><b>const</b> <a href="../iota-framework/clock.md#0x2_clock_ENotSystemAddress">ENotSystemAddress</a>: u64 = 0;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/clock.md#0x2_clock_timestamp_ms">timestamp_ms</a>(<a href="../iota-framework/clock.md#0x2_clock">clock</a>: &<a href="../iota-framework/clock.md#0x2_clock_Clock">clock::Clock</a>): u64
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="../iota-framework/clock.md#0x2_clock_timestamp_ms">timestamp_ms</a>(<a href="../iota-framework/clock.md#0x2_clock">clock</a>: &<a href="../iota-framework/clock.md#0x2_clock_Clock">Clock</a>): u64 {
...
<pre><code><b>fun</b> <a href="../iota-framework/clock.md#0x2_clock_consensus_commit_prologue">consensus_commit_prologue</a>(<a href="../iota-framework/clock.md#0x2_clock">clock</a>: &<b>mut</b> <a href="../iota-framework/clock.md#0x2_clock_Clock">clock::Clock</a>, timestamp_ms: u64, ctx: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>)
</code></pre>
