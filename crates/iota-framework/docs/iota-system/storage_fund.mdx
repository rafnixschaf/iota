...
<pre><code>
<b>public</b>(<b>friend</b>) <b>fun</b> <Link to="storage_fund#0x3_storage_fund_advance_epoch">advance_epoch</Link>(self: &<b>mut</b> <Link to="storage_fund#0x3_storage_fund_StorageFund">storage_fund::StorageFund</Link>, storage_charges: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;, storage_fund_reinvestment: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;, leftover_staking_rewards: <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;, storage_rebate_amount: u64, non_refundable_storage_fee_amount: u64): <Link to="../iota-framework/balance#0x2_balance_Balance">balance::Balance</Link>&lt;<Link to="../iota-framework/iota#0x2_iota_IOTA">iota::IOTA</Link>&gt;
</code></pre>
...
<b>public</b>(package) <b>fun</b> <Link to="storage_fund#0x3_storage_fund_advance_epoch">advance_epoch</Link>(
    ...
    // Both the reinvestment and leftover rewards are not <b>to</b> be refunded so they go <b>to</b> the non-refundable <Link to="../iota-framework/balance#0x2_balance">balance</Link>.
