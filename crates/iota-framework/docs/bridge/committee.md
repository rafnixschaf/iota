...
<b>use</b> <a href="../iota-framework/ecdsa_k1.md#0x2_ecdsa_k1">0x2::ecdsa_k1</a>;
...
<dl>
<dt>
<code>members: <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;, <a href="committee.md#0xb_committee_CommitteeMember">committee::CommitteeMember</a>&gt;</code>
</dt>
<dd>

</dd>
<dt>
<code>member_registrations: <a href="../iota-framework/vec_map.md#0x2_vec_map_VecMap">vec_map::VecMap</a>&lt;<b>address</b>, <a href="committee.md#0xb_committee_CommitteeMemberRegistration">committee::CommitteeMemberRegistration</a>&gt;</code>
</dt>
<dd>
...
<dt>
<code><a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>: <a href="../move-stdlib/u64.md#0x1_u64">u64</a></code>
</dt>
<dd>
...
<a name="0xb_committee_IOTA_MESSAGE_PREFIX"></a>



<pre><code><b>const</b> <a href="committee.md#0xb_committee_IOTA_MESSAGE_PREFIX">IOTA_MESSAGE_PREFIX</a>: <a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; = [73, 79, 84, 65, 95, 66, 82, 73, 68, 71, 69, 95, 77, 69, 83, 83, 65, 71, 69];
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="committee.md#0xb_committee_verify_signatures">verify_signatures</a>(
    ...
    <b>let</b> <b>mut</b> seen_pub_key = <a href="../iota-framework/vec_set.md#0x2_vec_set_empty">vec_set::empty</a>&lt;<a href="../move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt;&gt;();
    ...
    <b>let</b> <b>mut</b> message_bytes = <a href="committee.md#0xb_committee_IOTA_MESSAGE_PREFIX">IOTA_MESSAGE_PREFIX</a>;
    ...
    <b>while</b> (i &lt; signature_counts) {
        <b>let</b> pubkey = <a href="../iota-framework/ecdsa_k1.md#0x2_ecdsa_k1_secp256k1_ecrecover">ecdsa_k1::secp256k1_ecrecover</a>(&signatures[i], &message_bytes, 0);
        ...
        <b>if</b> (!member.blocklisted) {
            threshold = threshold + member.<a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>;
        };
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="committee.md#0xb_committee_create">create</a>(ctx: &<a href="../iota-framework/tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="committee.md#0xb_committee_BridgeCommittee">committee::BridgeCommittee</a>
</code></pre>
...
<pre><code><b>public</b>(<a href="../iota-framework/package.md#0x2_package">package</a>) <b>fun</b> <a href="committee.md#0xb_committee_create">create</a>(ctx: &TxContext): <a href="committee.md#0xb_committee_BridgeCommittee">BridgeCommittee</a> {
    <b>assert</b>!(<a href="../iota-framework/tx_context.md#0x2_tx_context_sender">tx_context::sender</a>(ctx) == @0x0, <a href="committee.md#0xb_committee_ENotSystemAddress">ENotSystemAddress</a>);
    <a href="committee.md#0xb_committee_BridgeCommittee">BridgeCommittee</a> {
        members: <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
        member_registrations: <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>(),
...
<pre><code><b>public</b>(<a href="../iota-framework/package.md#0x2_package">package</a>) <b>fun</b> <a href="committee.md#0xb_committee_register">register</a>(
    ...
    // sender must be the same sender that created the <a href="../iota-system/validator.md#0x3_validator">validator</a> <a href="../iota-framework/object.md#0x2_object">object</a>, this is <b>to</b> prevent DDoS from non-<a href="../iota-system/validator.md#0x3_validator">validator</a> actor.
    ...
    // Sender is active <a href="../iota-system/validator.md#0x3_validator">validator</a>, record the registration

    // In case <a href="../iota-system/validator.md#0x3_validator">validator</a> need <b>to</b> <b>update</b> the info
    ...
    // need <b>to</b> deploy proper <a href="../iota-system/validator.md#0x3_validator">validator</a> changes <b>to</b> stop end of epoch from failing).
...
<pre><code><b>public</b>(<a href="../iota-framework/package.md#0x2_package">package</a>) <b>fun</b> <a href="committee.md#0xb_committee_try_create_next_committee">try_create_next_committee</a>(
    self: &<b>mut</b> <a href="committee.md#0xb_committee_BridgeCommittee">BridgeCommittee</a>,
    ...
    <b>let</b> <b>mut</b> i = 0;
    <b>let</b> <b>mut</b> new_members = <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();
    ...
    <b>while</b> (i &lt; self.member_registrations.size()) {
        ...
        // Find <a href="../iota-system/validator.md#0x3_validator">validator</a> stake amount from system state

        // Process registration <b>if</b> it's active <a href="../iota-system/validator.md#0x3_validator">validator</a>
        <b>let</b> <a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a> = active_validator_voting_power.try_get(&registration.iota_address);
        <b>if</b> (<a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>.is_some()) {
            <b>let</b> <a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a> = <a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>.destroy_some();
            stake_participation_percentage = stake_participation_percentage + <a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>;
            ...
            <b>let</b> member = <a href="committee.md#0xb_committee_CommitteeMember">CommitteeMember</a> {
                ...
                <a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a>: (<a href="../iota-system/voting_power.md#0x3_voting_power">voting_power</a> <b>as</b> <a href="../move-stdlib/u64.md#0x1_u64">u64</a>),
    ...
    <b>if</b> (stake_participation_percentage &gt;= min_stake_participation_percentage) {
        // Clear registrations
        self.member_registrations = <a href="../iota-framework/vec_map.md#0x2_vec_map_empty">vec_map::empty</a>();
...
<pre><code><b>public</b>(<a href="../iota-framework/package.md#0x2_package">package</a>) <b>fun</b> <a href="committee.md#0xb_committee_execute_blocklist">execute_blocklist</a>(self: &<b>mut</b> <a href="committee.md#0xb_committee_BridgeCommittee">BridgeCommittee</a>, blocklist: Blocklist) {
...
<pre><code><b>public</b>(<a href="../iota-framework/package.md#0x2_package">package</a>) <b>fun</b> <a href="committee.md#0xb_committee_committee_members">committee_members</a>(
    self: &<a href="committee.md#0xb_committee_BridgeCommittee">BridgeCommittee</a>,
