...
module iota_system::iota_system_state_inner {
    ...
    public(package) fun insert_system_display_object<T: key>(
        ...
        let key = system_display_object_key<T>();
    ...
    public(package) fun borrow_system_display_object<T: key>(self: &IotaSystemStateV2): &Display<T> {
        // Get a display object unique key.
        let key = system_display_object_key<T>();
    ...
    public(package) fun borrow_system_display_object_mut<T: key>(self: &mut IotaSystemStateV2): &mut Display<T> {
        // Get a display object unique key.
        let key = system_display_object_key<T>();
    ...
    public(package) fun contains_system_display_object<T: key>(self: &IotaSystemStateV2): bool {
        // Get a display object unique key.
        let key = system_display_object_key<T>();
    ...
    fun system_display_object_key<T>(): String {
