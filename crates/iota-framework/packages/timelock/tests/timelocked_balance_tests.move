...
module timelock::timelocked_balance_tests {
    ...
    fun test_split_timelocked_balances() {
        ...
        // Split the timelock.
        let split = timelocked_balance::split(&mut original, 3, scenario.ctx());
    ...
    fun test_split_and_transfer_timelocked_balances() {
        ...
        let split = timelocked_balance::split(&mut original, 3, scenario.ctx());
        split.self_transfer(scenario.ctx());
        scenario.next_tx(sender);
    ...
    fun test_split_zero_value_from_timelocked_balances() {
        ...
        // Split the timelock.
        let split = timelocked_balance::split(&mut original, 0, scenario.ctx());
    ...
    fun test_split_same_value_from_timelocked_balances() {
        ...
        // Split the timelock.
        let split = timelocked_balance::split(&mut original, 10, scenario.ctx());
    ...
    fun test_split_bigger_value_from_timelocked_balances() {
        ...
        // Split the timelock.
        let split = timelocked_balance::split(&mut original, 11, scenario.ctx());
