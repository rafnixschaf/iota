...
pub struct SuiSystemStateSummary {
    ...
    /// ID of the object that maps from staking pool's ID to the sui address of
    /// a validator.
...
/// This is the JSON-RPC type for the SUI validator. It flattens all inner
...
/// `SuiValidatorSummary`, works for validator candidates, active validators, as
