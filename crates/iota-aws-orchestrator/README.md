...
```json
{
  ...
  "specs": "m5d.8xlarge",
  "repository": {
    "url": "https://github.com/iotaledger/kinesis.git",
    "commit": "main"
  },
...
```json
"repository": {
  "url": "http://[your_token]@github.com/mystenlabs/iota.git",
  "commit": "main"
}
```
...
There is support to benchmark either Iota or Narwhal only. To choose which protocol to benchmark, you can set the `Protocol` & `BenchmarkType` field [here](https://github.com/iotaledger/kinesis/blob/main/crates/iota-aws-orchestrator/src/main.rs#L33-L34)
