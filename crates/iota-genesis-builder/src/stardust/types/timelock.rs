...
pub enum VestedRewardError {
    ...
    ExecutionError(iota_types::error::ExecutionError),
...
impl From<iota_types::error::ExecutionError> for VestedRewardError {
    fn from(err: iota_types::error::ExecutionError) -> Self {
