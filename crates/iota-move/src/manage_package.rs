...
pub struct ManagePackage {
    ...
    /// is the same as 'original-id' if the package is immutable and published
    /// once. It is different from 'original-id' if the package has been
    /// upgraded to a different address.
    pub latest_id: ObjectID,
    #[clap(long = "version-number")]
    /// The version number of the published package. It is '1' if the package is
    /// immutable and published once. It is some number greater than '1' if the
    /// package has been upgraded once or more.
