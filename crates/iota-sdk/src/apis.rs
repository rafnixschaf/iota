...
use iota_json_rpc_types::{CheckpointPage, IotaLoadedChildObjectsResponse};
...
impl ReadApi {
    ...
    ///
    /// Loaded child objects ([IotaLoadedChildObject](iota_json_rpc_types::IotaLoadedChildObject)) are the non-input objects that the transaction at the digest loaded
