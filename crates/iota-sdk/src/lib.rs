...
//! [TypeScript](https://github.com/iotaledger/kinesis/tree/main/sdk/typescript/).
...
//! in the [main repository](https://github.com/iotaledger/kinesis/tree/main/crates/iota-sdk/examples).
