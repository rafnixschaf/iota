...
use iota_indexer::models::objects::{StoredDeletedHistoryObject, StoredHistoryObject, StoredObject};
use iota_indexer::schema::{objects, objects_history, objects_snapshot};
