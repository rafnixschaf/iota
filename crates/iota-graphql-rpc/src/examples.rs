...
"#,
    ...
    md.write("This page showcases a number of queries to interact with the network. These examples can also be found in the [repository](https://github.com/iotaledger/kinesis/tree/main/crates/iota-graphql-rpc/examples). You can use the [interactive online IDE](https://mainnet.iota.io/rpc/graphql) to run these examples.")?;
...
fn test_generate_markdown() {
    ...
    if current_content != new_content {
        ...
        panic!("Doc examples have changed. Please run `iota-graphql-rpc generate-examples` to update the docs. Diff: {}", res.join(""));
    }
}
