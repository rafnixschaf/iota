...
pub struct MigrationTransactions {
    inner: BTreeMap<TransactionKey, (Transaction, TransactionEvents, Vec<Object>)>,
}

impl MigrationTransactions {
    pub fn new(
        data: BTreeMap<TransactionKey, (Transaction, TransactionEvents, Vec<Object>)>,
    ) -> Self {
        Self { inner: data }
    }

    pub fn data(&self) -> &BTreeMap<TransactionKey, (Transaction, TransactionEvents, Vec<Object>)> {
        &self.inner
    }
