...
/// network. For Sui, we are returning the latest object refs for all the input
...
pub async fn metadata(
    ...
    // If required amount is None (all SUI) or failed to select coin (might not have
    // enough SUI), select all coins.
