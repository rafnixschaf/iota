...
The easiest way to write tests that run in the simulation testing framework is to use [SwarmBuilder](https://github.com/iotaledger/kinesis/blob/main/crates/iota-swarm/src/memory/swarm.rs#L47) to start your validators.
...
https://github.com/iotaledger/kinesis/blob/main/crates/iota/tests/checkpoints_tests.rs is a good example of this.
...
There is a small but growing library of functions for building network configs in [iota_simulator::configs](https://github.com/iotaledger/kinesis/blob/main/crates/iota-simulator/src/lib.rs).

There are also some examples of network configuration at https://github.com/iotaledger/kinesis/blob/main/crates/iota-benchmark/tests/simtest.rs#L52.
