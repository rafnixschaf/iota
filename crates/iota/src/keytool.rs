...
use iota_types::signature::{AuthenticatorTrait, GenericSignature, VerifyParams};
use iota_types::transaction::{TransactionData, TransactionDataAPI};
use iota_types::zk_login_authenticator::ZkLoginAuthenticator;
use iota_types::zk_login_util::get_zklogin_inputs;
    ...
    pub async fn execute(self, keystore: &mut Keystore) -> Result<CommandOutput, anyhow::Error> {
        let cmd_result = Ok(match self {
            ...
            KeyToolCommand::ZkLoginSignAndExecuteTx {
                ...
                println!("Finish login and paste the entire URL here (e.g. https://iota.io/#id_token=...):");
