...
pub enum IotaClientCommands {
    ...
    Call {
        ...
        /// can be used to execute transaction with `iota client execute-combined-signed-tx --signed-tx-bytes
        /// <SIGNED_TX_BYTES>`.
        #[clap(long, required = false)]
    ...
    TransferIota {
        ...
        /// Iota coin object to transfer, ID in 20 bytes Hex string. This is also the gas object.
        #[clap(long)]
...
async fn construct_move_call_transaction(
    ...
    // Convert all numeric input to String, this will allow number input from the CLI without failing IotaJSON's checks.
    let args = args
        .into_iter()
