...
pub trait IndexerApi {
    ...
    async fn query_events(
        &self,
        /// The event query criteria. See [Event filter](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/build/event_api#event-filters) documentation for examples.
        query: EventFilter,
    ...
    fn subscribe_event(
        &self,
        /// The filter criteria of the event stream. See [Event filter](https://wiki:zsijvJgGyfCk4Eo@docs.iota.org/build/event_api#event-filters) documentation for examples.
        filter: EventFilter,
    ) -> SubscriptionResult;
