...
mod sim_only_tests {
    ...
    use sui_types::{
        ...
        SUI_FRAMEWORK_PACKAGE_ID, SUI_RANDOMNESS_STATE_OBJECT_ID, SUI_SYSTEM_PACKAGE_ID,
    ...
    async fn sui_system_state_production_upgrade_test() {
        // Use this test to test a real sui system state upgrade. To make this test
        // work, put the new sui system in a new path and point to it in the
