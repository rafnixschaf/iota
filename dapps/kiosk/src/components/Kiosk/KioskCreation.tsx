        ...
        <div className="min-h-[70vh] container py-24 gap-4 mt-6">
            <div className="lg:w-7/12 mx-auto">
                ...
                <p className="pb-3">
                    ...
                    your digital assets and list them for sale on the Sui network. Anyone can view
                    your kiosk and the assets you place in it.
                </p>
                <p className="pb-3">
                    The demo app works only on <strong>Sui Testnet.</strong> Make sure that your
                    wallet connects to Testnet and that you have at least 1 SUI to cover gas fees.
                    You can get test SUI tokens using{' '}
                    <a
