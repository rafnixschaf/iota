...
3. In the search bar labeled _Search Extensions in Marketplace_, type **Mysten**. The Move extension
...
Preferences > Settings_). Search for the `move.sui.path` user setting, set it to the new location of
