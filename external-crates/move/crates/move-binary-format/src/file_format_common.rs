...
// Static assertions about the encoding of the flavor into the version of the
// binary format.
const _: () = {
...
/// Encoding of a the flavor into the version of the binary format for versions
/// >= 7.
...
pub const VARIANT_COUNT_MAX: u64 = {
    // These assertions are performed at compile time to ensure that the encoding of
    // enum variants does not exceed 127.
    assert!(
