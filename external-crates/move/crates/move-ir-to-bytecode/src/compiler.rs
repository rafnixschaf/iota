...
pub fn compile_module<'a>(
    ...
    // Explicitly declare all structs and enums as they will be included even if not
    // used
...
fn set_module_version(module: &mut CompiledModule, version: Option<u32>) {
    ...
    // Leave this const, and the const assertion here as a reminder to update this
    // code if the version changes
