...
mod checked {
    ...
    fn publish_and_verify_modules(
        ...
        // TODO(https://github.com/iotaledger/kinesis/issues/69): avoid this redundant serialization by exposing VM API that allows us to run the linker directly on `Vec<CompiledModule>`
