...
///              + ecdsa_r1_ecrecover_msg_cost_per_byte    * size_of(msg) | covers cost of operating
///                on each byte of `msg`
///              + ecdsa_r1_ecrecover_msg_cost_per_block   * num_blocks(msg) | covers cost of
...
///              + ecdsa_r1_secp256r1_verify_msg_cost_per_byte    * size_of(msg) | covers cost of
///                operating on each byte of `msg`
///              + ecdsa_r1_secp256r1_verify_msg_cost_per_block   * num_blocks(msg)     | covers
