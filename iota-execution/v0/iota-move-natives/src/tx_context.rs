...
/// Implementation of the Move native function `fun derive_id(tx_hash:
/// vector<u8>, ids_created: u64): address`   gas cost:
/// tx_context_derive_id_cost_base                | we operate on fixed size
/// data structures ************************************************************
/// ***********************************
pub fn derive_id(
