...
module nfts::random_nft_airdrop {
    use std::string;
    use std::vector;
    use iota::object::{Self, UID, delete};
    use iota::random;
...
module nfts::random_nft_airdrop_tests {
    ...
    use std::vector;
    use iota::random;
    use iota::random::{Random, update_randomness_state_for_testing};
    use iota::test_scenario::{ctx, take_from_sender, next_tx, return_to_sender};
