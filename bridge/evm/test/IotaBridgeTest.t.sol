...
contract IotaBridgeTest is BridgeBaseTest, IIotaBridge {
    ...
    function testBridgeERC20UnsupportedToken() public {
        ...
        bridge.bridgeERC20(255, 1 ether, abi.encode("iotaAddress"), 0);
    }

    function testBridgeERC20InsufficientAllowance() public {
        vm.expectRevert(bytes("IotaBridge: Insufficient allowance"));
        bridge.bridgeERC20(BridgeMessage.ETH, type(uint256).max, abi.encode("iotaAddress"), 0);
    }
    ...
    function testBridgeWETH() public {
        ...
        emit TokensDeposited(
            ...
            deployer,
            abi.encode("iotaAddress")
        );

        bridge.bridgeERC20(BridgeMessage.ETH, 1 ether, abi.encode("iotaAddress"), 0);
        ...
        bridge.bridgeERC20(
            BridgeMessage.ETH, 2_000_000_011_000_000_888, abi.encode("iotaAddress"), 0
        );
    ...
    function testBridgeEth() public {
        ...
        bridge.bridgeETH{value: 1 ether}(abi.encode("iotaAddress"), 0);
        assertEq(IERC20(wETH).balanceOf(address(vault)), 1 ether);
