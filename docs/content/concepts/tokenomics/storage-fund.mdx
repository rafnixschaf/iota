...
- It creates deflationary pressure over the IOTA token in that increased activity leads to larger storage requirements and to more IOTA removed from circulation.
