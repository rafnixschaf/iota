...
To see a detailed definition for each field, see each enum definition [in the source code](https://github.com/iotaledger/kinesis/blob/0dc1a38f800fc2d8fabe11477fdef702058cf00d/crates/iota-types/src/intent.rs).
...
The authority signature is created using the protocol key. The data that it commits to is also an intent message `intent || message`. See all available intent scopes [in the source code](https://github.com/iotaledger/kinesis/blob/0dc1a38f800fc2d8fabe11477fdef702058cf00d/crates/iota-types/src/intent.rs#L66)
...
1. [Struct and enum definitions](https://github.com/iotaledger/kinesis/blob/0dc1a38f800fc2d8fabe11477fdef702058cf00d/crates/iota-types/src/intent.rs)
2. [Test](https://github.com/iotaledger/kinesis/blob/d009e82fa35bda4f2b3e7a86a9529d36c32a8159/crates/iota-types/src/unit_tests/intent_tests.rs)
3. User transaction intent signing [PR 1](https://github.com/iotaledger/kinesis/pull/6445), [PR 2](https://github.com/iotaledger/kinesis/pull/8321)
4. Authority intent signing [PR 1](https://github.com/iotaledger/kinesis/pull/8154), [PR 2](https://github.com/iotaledger/kinesis/pull/8726)