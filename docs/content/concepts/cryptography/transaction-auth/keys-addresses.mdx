...
The `coin_type` value is managed with a repository of all other cryptocurrencies. Both signature schemes use Sui's registered coin_type, 4218 (SUI on a telephone keypad).
...
```shell
sui keytool import "TEST_MNEMONIC" ed25519 "m/44'/4218'/0'/0'/0'"
sui client new-address ed25519 "m/44'/4218'/0'/0'/0'"
```
