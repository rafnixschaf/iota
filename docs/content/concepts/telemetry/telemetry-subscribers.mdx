...
The `TelemetryConfig` allows setting various configuration options, such as OpenTelemetry tracing, outputting JSON logs,
...
the [`mysten-metrics` crate](mysten-metrics.mdx).
