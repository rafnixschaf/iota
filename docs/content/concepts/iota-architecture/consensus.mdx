...
- a high-throughput data availability engine, with cryptographic proofs of data availability at a [primary node](https://github.com/iotaledger/iota/blob/main/narwhal/primary)
- a structured graph data structure for traversing this information
- a scaled architecture, splitting the disk I/O and networking requirements across several [workers](https://github.com/iotaledger/iota/blob/main/narwhal/worker)

The [consensus](https://github.com/iotaledger/iota/blob/main/narwhal/consensus) component offers a zero-message overhead consensus algorithm, leveraging graph traversals.
