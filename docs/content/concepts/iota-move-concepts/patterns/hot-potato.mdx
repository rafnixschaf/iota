...
The IOTA repository includes [several examples](https://github.com/iotaledger/kinesis/tree/main/examples/move) that demonstrate IOTA capabilities. The [Flash Loan](https://github.com/iotaledger/kinesis/blob/main/examples/move/flash_lender/sources/example.move) code in those examples demonstrates the pattern this topic describes.
