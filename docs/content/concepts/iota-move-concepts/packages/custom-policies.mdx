...
Refer to the [implementation for digest calculation](https://github.com/iotaledger/kinesis/blob/d8cb153d886d54752763fbdab631b062da7d894b/crates/iota-types/src/move_package.rs#L232-L251) for more information, but in most cases, you can rely on the Move toolchain to output the digest as part of the build, when passing the `--dump-bytecode-as-base64` flag:

```bash
iota move build --dump-bytecode-as-base64
FETCHING GIT DEPENDENCY https://github.com/iotaledger/kinesis.git
...
import { getFullnodeUrl, IotaClient } from '@mysten/iota.js/client';
import { Ed25519Keypair } from '@mysten/iota.js/keypairs/ed25519';
import { TransactionBlock, UpgradePolicy } from '@mysten/iota.js/transactions';
import { fromB64 } from '@mysten/iota.js/utils';
