...
You can use one of the following functions (defined in the [transfer module](https://github.com/iotaledger/kinesis/blob/main/crates/iota-framework/packages/iota-framework/sources/transfer.move)) to create address-owned objects.
