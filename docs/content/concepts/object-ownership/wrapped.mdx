...
Find the full source code in the [trusted_swap](https://github.com/iotaledger/kinesis/blob/main/examples/move/trusted_swap) example.

To view a more complex example of how to use direct wrapping, see the [escrow](https://github.com/iotaledger/kinesis/tree/main/examples/move/escrow) example.
...
Find the source code in the [simple_warrior](https://github.com/iotaledger/kinesis/tree/main/examples/move/simple_warrior) example.

To view a more complex example, see [hero](https://github.com/iotaledger/kinesis/tree/main/examples/move/hero).
