...
Publishing a coin on IOTA is nearly as straightforward as publishing a new type. The main difference is the requirement of a [one-time witness](/concepts/iota-move-concepts/one-time-witness.mdx) when creating a coin.
