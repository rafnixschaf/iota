...
To fully appreciate the possibilities PTBs offer, you must build them. Using tools like the [Iota TypeScript SDK](https://wiki.iota.org/references/ts-sdk/typescript), you can begin to understand the power and flexibility they provide.
