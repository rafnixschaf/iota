...
The full code example below can be found under [crates/iota-sdk](https://github.com/iotaledger/kinesis/blob/main/crates/iota-sdk/examples/sign_tx_guide.rs).
