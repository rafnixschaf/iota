...
You can request test tokens within [Iota Wallet](https://github.com/MystenLabs/mysten-app-docs/blob/main/mysten-iota-wallet.md#add-iota-tokens-to-your-iota-wallet).
