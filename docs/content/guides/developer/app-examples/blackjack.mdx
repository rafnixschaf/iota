...
A deployed version of the blackjack game is online at [Mysten Blackjack](https://blackjack-iota.vercel.app/).
...
You can also find the [full repository for this example here](https://github.com/MystenLabs/blackjack-iota).
...
The [`single_player_blackjack.move`](https://github.com/MystenLabs/blackjack-iota/blob/main/move/blackjack/sources/single_player_blackjack.move) module includes several constants that define game statuses and help track the game's progress:
...
- [games/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/api/games):
...
- [health/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/api/health): A simple healthcheck endpoint to check the API availability
- [helpers/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/api/helpers): Multiple helper functions used in various endpoints
- [services/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/api/services): The core logic of the backend, that signs and executes the transactions on the IOTA blockchain
- [utils/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/api/utils): Reusable methods for signing the transactions as the dealer, and sponsoring them with Shinami, to avoid gas coins equivocation
...
The main code of the frontend lies under the [app/src/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/) directory.
The main sub-directories are:
  - [app/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/app/): The main code of the pages and the API endpoints.
  - [components/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/components): The reusable components of the app, organized in sub-directories.
  - [hooks/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/hooks): The custom hooks used in the app.
  - [helpers/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/helpers), [utils/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/utils), [lib/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/lib): Multiple helper functions and utilities.
  - [types/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/types): The types/interfaces used in the app.
  - [styles/](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/styles): The global css files to style our app.
...
- **BlackjackBanner**: The [BlackjackBanner](https://github.com/MystenLabs/blackjack-iota/blob/main/app/src/components/home/BlackjackBanner.tsx) component is used as a custom view to display when the player wins with a blackjack.
...
The complete app example can be found in [the blackjack-iota repo](https://github.com/MystenLabs/blackjack-iota).
