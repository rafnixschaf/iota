...
This guide covers three different implementations of the game tic-tac-toe on Iota. The first example utilizes a centralized admin that marks the board on the users’ behalf. The second example utilizes a shared object that both users can mutate. And the third example utilizes a multisig, where instead of sharing the game board, it's in a 1-of-2 multisig of both users’ accounts.

## owned.move ([source](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/move/sources/owned.move))
...
To view the entire source code, see the [owned.move source file](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/move/sources/owned.move). You can find the rest of the logic, including how to check for a winner, as well as deleting the gameboard after the game concludes there.
...
## shared.move ([source](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/move/sources/shared.move))
...
### Creating a multisig account ([source](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/ui/src/MultiSig.ts))
...
### Building a multisig transaction ([source](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/ui/src/hooks/useTransactions.ts))
...
### Placing a mark ([source](https://github.com/iotaledger/iota/blob/main/examples/tic-tac-toe/ui/src/pages/Game.tsx))
