...
You can find the full source code in [shared_tic_tac_toe.move](https://github.com/iotaledger/kinesis/blob/main/iota_programmability/examples/games/sources/shared_tic_tac_toe.move)
