...
- The first struct, `AdminCap`, is a [capability](concepts/iota-move-concepts/patterns/capabilities.mdx).
...
- Run `npm install @mysten/bcs @mysten/iota.js axios csv-parse csv-parser dotenv pino retry-axios --save` to install the other dependencies and save them to your package.json file. These dependencies are:
    - **@mysten/bcs**: a library for blockchain services.
    - **@mysten/iota.js**: a library for smart user interfaces.
