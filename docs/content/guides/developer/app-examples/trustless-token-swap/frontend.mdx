...
- This project is bootstrapped through `pnpm create @mysten/dapp`. Please check out [@mysten/create-dapp](https://sdk.mystenlabs.com/dapp-kit/create-dapp) for how to scaffold a React.js Iota dApp project quickly.
...
The full source code of the demo bear smart contract is available at [Trading Contracts Demo directory](https://github.com/iotaledger/kinesis/tree/main/examples/trading/contracts/demo)
