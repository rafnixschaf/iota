...
You can build custom indexers using the Iota micro-data ingestion framework. To create an indexer, you subscribe to a checkpoint stream with full checkpoint content. This stream can be one of the publicly available streams from Mysten Labs, one that you set up in your local environment, or a combination of the two.  
...
* Iota data ingestion daemon that runs internal [pipelines](https://github.com/iotaledger/kinesis/tree/main/crates/iota-data-ingestion/src/).
* Iota Name Service's custom [indexer](https://github.com/iotaledger/kinesis/tree/main/crates/iotans-indexer/src).
