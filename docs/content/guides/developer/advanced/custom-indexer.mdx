...
* Iota data ingestion daemon that runs internal [pipelines](https://github.com/iotaledger/iota/tree/main/crates/iota-data-ingestion/src/).
* Iota Name Service's custom [indexer](https://github.com/iotaledger/iota/tree/main/crates/iotans-indexer/src).
