...
You can find a public facing reference to the WASM library in the [move-binary-format-wasm](https://github.com/iotaledger/kinesis/tree/main/sdk/move-binary-format-wasm) Iota repo subfolder.
