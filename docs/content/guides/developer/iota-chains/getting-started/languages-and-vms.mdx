...
import EVMCompatibility from '../../../../_snippets/iota-chains/EVM_compatibility.md'
...
called [`evm`](../../../../references/iota-chains/core-contracts/evm.md). This core contract is responsible for running EVM code and
