...
[core contracts](../../../../references/iota-chains/core-contracts/overview.md) deployed, as well as the
[Magic Contract](../../../../references/iota-chains/magic-contract/introduction.md).
