...
supports [EVM/Solidity](getting-started/languages-and-vms.mdxevmsolidity-based-smart-contracts)
smart contracts, as well as an **experimental** [Wasm VM](getting-started/languages-and-vms.mdxwasm-vm-for-isc).
