...
Define the [`NativeTokenScheme`](../../../../../../references/iota-chains/magic-contract/ISCTypes.md#nativetokenscheme) by specifying the `maximumSupply`.
...
Minting native tokens and registering them as ERC20 tokens using [`createNativeTokenFoundry`](../../../../../../references/iota-chains/magic-contract/ISCAccounts.md#createnativetokenfoundry) method
