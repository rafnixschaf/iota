...
```shell
UPDATING GIT DEPENDENCY https://github.com/iotaledger/kinesis.git
...
You can refer to the source code for the package (with all the tests and functions properly adjusted) in the [first_package](https://github.com/iotaledger/kinesis/tree/main/examples/move/first_package/sources/example.move) module in the `iota/examples` directory.
