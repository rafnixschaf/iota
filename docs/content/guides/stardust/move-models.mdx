...
You may find more information on the original Stardust ledger and asset types in [TIP-18](https://wiki.iota.org/tips/tips/TIP-0018/).
...
[Basic outputs](https://wiki.iota.org/tips/tips/TIP-0018/#basic-output) from the Stardust ledger that:
    - contain IOTA or SMR tokens only (no native tokens),
    - have only an `Address Unlock Condition` and no other [unlock conditions](https://wiki.iota.org/tips/tips/TIP-0018/#unlock-conditions), and
    - have no [output features](https://wiki.iota.org/tips/tips/TIP-0018/#features),
...
Native tokens in Stardust are user-defined tokens that were minted via [Foundries](https://wiki.iota.org/tips/tips/TIP-0018/#foundry-output).
...
A native token and its foundry from the Stardust ledger therefore translate to the following in the move ledger:
 - A published move package that defines the currency type ([one-time witness](../../concepts/iota-move-concepts/one-time-witness.mdx))
   ...
   The parameters of the template are filled with the [IRC-30 metadata](https://wiki.iota.org/tips/tips/TIP-0030/) of the native token from Stardust.
...
[Aliases](https://wiki.iota.org/tips/tips/TIP-0018/#alias-output) were primarily developed in
...
The [`Storage Deposit Return Unlock Condition`](https://wiki.iota.org/tips/tips/TIP-0018/#storage-deposit-return-unlock-condition)
...
A [stardust timelock](https://wiki.iota.org/tips/tips/TIP-0018/#timelock-unlock-condition)
...
[`Timelock<Balance<IOTA>>`](../../references/framework/timelock/timelock.md#resource-timelock).
  - `Timelock` objects can be staked to validators of the network to earn rewards. The functionality is provided by the
     [timelock::timelocked_staking](../../references/framework/timelock/timelocked_staking.md) module.
  - The [timelock](../../references/framework/timelock/timelock.md) package and it's utilities can be used by anyone to create their own timelocked assets.

::::

### Expiration Unlock Condition

The [`Expiration Unlock Condition`](https://wiki.iota.org/tips/tips/TIP-0018/#expiration-unlock-condition)
...
The following unlock conditions from Stardust are not supported in the move ledger and are therefore not migrated:
 - [State Controller Address Unlock Condition](https://wiki.iota.org/tips/tips/TIP-0018/#state-controller-address-unlock-condition) and
...
Stardust UTXOs introduced [output features](https://wiki.iota.org/tips/tips/TIP-0018/#features)
...
| [Vested Rewards From the Stardust Upgrade](https://github.com/iotaledger/new_supply) | [`Timelock<Balance<IOTA>>`](../../references/framework/timelock/timelock.md#resource-timelock) objects.                                                                                                                                                                                                                                                                     | -                                                                                                                                                                                                                                                                                              |
