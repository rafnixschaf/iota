...
- [Systemd](https://github.com/iotaledger/kinesis/blob/main/nre/systemd/README.md)
- [Ansible](https://github.com/iotaledger/kinesis/blob/main/nre/ansible/README.md)
- [Docker Compose](https://github.com/iotaledger/kinesis/blob/main/nre/docker/README.md)
...
See [Validator](https://github.com/iotaledger/kinesis/blob/main/nre/config/validator.yaml) for configuration templates.
...
- [Ansible](https://github.com/iotaledger/kinesis/blob/main/nre/ansible/roles/iota-node/files/iota-node.service)
- [Native systemd](https://github.com/iotaledger/kinesis/blob/main/nre/systemd/iota-node.service)
- [Docker Compose](https://github.com/iotaledger/kinesis/blob/main/nre/docker/docker-compose.yaml)
...
- If using Docker Compose, look at the examples in the [README](https://github.com/iotaledger/kinesis/blob/main/nre/docker/README.md#logs).
...
- [Systemd](https://github.com/iotaledger/kinesis/blob/main/nre/systemd/README.md#updates)
- [Docker Compose](https://github.com/iotaledger/kinesis/blob/main/nre/docker/README.md#updates)
...
You can leverage [Validator Tool](https://github.com/iotaledger/kinesis/blob/main/nre/validator_tool.md) to perform majority of the following tasks.
