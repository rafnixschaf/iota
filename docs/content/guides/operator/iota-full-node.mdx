...
Follow the instructions here to run your own Iota Full.
...
Iota recommends running Iota Full nodes on Linux. Iota supports the Ubuntu and Debian distributions. You can also run a Iota Full node on macOS.
...
You can configure a Iota Full node either using Docker or by building from source.

### Using Docker Compose 

Follow the instructions in the [Full node Docker Readme](https://github.com/iotaledger/kinesis/tree/main/docker/fullnode#readme) to run a Iota Full node using Docker, including [resetting the environment](https://github.com/iotaledger/kinesis/tree/main/docker/fullnode#reset-the-environment).
...
1. Set up your fork of the Iota repository:
    1. Go to the [Iota repository](https://github.com/iotaledger/kinesis) on GitHub and click the Fork button in the top right-hand corner of the screen.
...
1. Set up the Iota repository as a git remote:
    `git remote add upstream https://github.com/iotaledger/kinesis`
1. Sync your fork:
    `git fetch upstream`
...
1. Make a copy of the [Full node YAML template](https://github.com/iotaledger/kinesis/blob/main/crates/iota-config/data/fullnode-template.yaml):
    `cp crates/iota-config/data/fullnode-template.yaml fullnode.yaml`
1. Download the genesis blob for the network to use:
    - [Devnet genesis blob](https://github.com/iotaledger/kinesis-genesis/raw/main/devnet/genesis.blob):
        `curl -fLJO https://github.com/iotaledger/kinesis-genesis/raw/main/devnet/genesis.blob`
    - [Testnet genesis blob](https://github.com/iotaledger/kinesis-genesis/raw/main/testnet/genesis.blob):
        `curl -fLJO https://github.com/iotaledger/kinesis-genesis/raw/main/testnet/genesis.blob`
    - [Mainnet genesis blob](https://github.com/iotaledger/kinesis-genesis/raw/main/mainnet/genesis.blob):
        `curl -fLJO https://github.com/iotaledger/kinesis-genesis/raw/main/mainnet/genesis.blob`
...
Follow the instructions to [reset the environment](https://github.com/iotaledger/kinesis/tree/main/docker/fullnode#reset-the-environment), namely by running the command:
