...
zkLogin is a IOTA primitive that enables you to send transactions from a IOTA address using an OAuth credential, without publicly linking the two. zkLogin provides a description of the primitive and how to implement it.

Go to [zkLogin](./zklogin.mdx).
