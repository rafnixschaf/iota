...
3. **UpgradeCap**: An `UpgradeCap` associated with the package. This object is used if you need to [upgrade your package](../iota-101/iota-move-concepts/packages/upgrade.mdx) or destroy it to make the package immutable.
