...
After you install VS Code and the `move-analyzer` extension, check out the [Move code examples](https://github.com/iotaledger/iota/tree/main/examples/move).
...
- [sdk](https://github.com/iotaledger/iota/tree/main/sdk): Contains the source code for different tools and SDKs, such as the IOTA TypeScript SDK, Kiosk SDK, BCS, zkLogin, dApp kit, and others.
...
- [narwhal](https://github.com/iotaledger/iota/tree/main/narwhal) - Mempool and consensus.
- [typescript-sdk](https://github.com/iotaledger/iota/tree/main/sdk/typescript/) - the IOTA TypeScript SDK.
