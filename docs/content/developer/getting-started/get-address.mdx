...
In IOTA Stardust we used a different address standard by default (Bech32, starting with `iota1` and `smr1`). To read more about this change check out the [address details migration page](../stardust/addresses.mdx).
