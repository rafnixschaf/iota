...
called [`evm`](../../../references/iota-evm/core-contracts/evm.md). This core contract is responsible for running EVM code and
...
![Wasp node ISC Host](/img/iota-evm/wasm_vm/IscHost.png)
...
![Wasm VM](/img/iota-evm/wasm_vm/WasmVM.png)
