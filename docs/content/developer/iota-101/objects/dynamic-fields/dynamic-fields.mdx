...
The modules for interacting with these fields can be found at [`dynamic_field`](https://github.com/iotaledger/iota/tree/main/crates/iota-framework/packages/iota-framework/sources/dynamic_field.move) and [`dynamic_object_field`](https://github.com/iotaledger/iota/tree/main/crates/iota-framework/packages/iota-framework/sources/dynamic_object_field.move) respectively.
