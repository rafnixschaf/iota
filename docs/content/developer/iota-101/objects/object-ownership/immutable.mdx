...
To convert an object into an immutable object, call the `public_freeze_object` function from the [transfer module](https://github.com/iotaledger/iota/blob/main/crates/iota-framework/packages/iota-framework/sources/transfer.move):
