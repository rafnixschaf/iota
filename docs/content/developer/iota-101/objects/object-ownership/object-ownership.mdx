...
Go to [Address-Owned Objects](address-owned.mdx).

## Dynamic fields

Dynamic fields and dynamic object fields on Iota are added and removed dynamically, affect gas only when accessed, and store heterogeneous values.

Go to [Dynamic (Object) Fields](../dynamic-fields/dynamic-fields.mdx).
...
Go to [Immutable Objects](immutable.mdx).
