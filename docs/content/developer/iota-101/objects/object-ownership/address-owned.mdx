...
You can use one of the following functions (defined in the [transfer module](https://github.com/iotaledger/iota/blob/main/crates/iota-framework/packages/iota-framework/sources/transfer.move)) to create address-owned objects.
...
You can access address-owned objects in two different ways, depending on whether the address owner of the object corresponds to an object ID.
