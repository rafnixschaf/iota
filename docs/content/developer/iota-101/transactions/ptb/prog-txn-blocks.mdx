...
- [Move Concepts](../../iota-move-concepts/iota-move-concepts.mdx)
...
Suppose you want to buy two items from a marketplace costing `100 MICROS`. You keep one for yourself, and then send the object and the remaining coin to a friend at address `0x808`. You can do that all in one PTB:
