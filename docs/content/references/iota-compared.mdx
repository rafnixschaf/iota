...
- The blockchain-oriented [Move programming language](../developer/evm-to-move/why-move.mdx) eases the developer experience
...
The [Narwhal mempool](https://github.com/iotaledger/iota/tree/develop/narwhal) offers a high-throughput data availability engine and a scaled architecture, splitting the disk I/O and networking requirements across several workers. And Bullshark is a zero-message overhead consensus algorithm, leveraging graph traversals.
...
IOTA uses a novel peer-reviewed consensus protocol based on [Narwhal and Bullshark](https://github.com/iotaledger/iota/tree/develop/narwhal), which provides a DAG-based mempool and efficient Byzantine Fault Tolerant (BFT) consensus. This is state-of-the-art in terms of both performance and robustness.
