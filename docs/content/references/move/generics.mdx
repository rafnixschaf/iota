...
The `<ability>` can be any of the four [abilities](./abilities.mdx), and a type parameter can be constrained with multiple abilities at once. So all of the following would be valid type parameter declarations:
