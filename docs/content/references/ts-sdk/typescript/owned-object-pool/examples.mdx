...
[`move/nft_app` example](https://github.com/MystenLabs/Iota_Owned_Object_Pools/tree/main/move/nft_app).
Notice how multiple `AdminCaps` are created in
[`genesis.move`](https://github.com/MystenLabs/Iota_Owned_Object_Pools/blob/main/move/nft_app/sources/genesis.move):
