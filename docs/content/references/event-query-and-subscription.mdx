...
Move calls emit Move events. You can [define custom events](https://examples.iota.io/basics/events.html) in Move contracts.
...
## IOTA event query criteria {#iota-event-query-criteria}
...
## Subscribe to IOTA events {#subscribe-events}
