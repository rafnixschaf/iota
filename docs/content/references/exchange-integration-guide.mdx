...
1.  Download the docker-compose.yaml file:
    ```bash
    wget https://github.com/iotaledger/kinesis/blob/branch-name/docker/fullnode/docker-compose.yaml
    ```
1.  Download the fullnode-template.yaml file:
    ```bash
    wget https://github.com/iotaledger/kinesis/raw/branch-name/crates/iota-config/data/fullnode-template.yaml
    ```
1.  Download the genesis.blob file:
    ```bash
    wget https://github.com/iotaledger/kinesis-genesis/raw/main/branch-name/genesis.blob
    ```
...
1.  Clone the Iota repository:
    ```bash
    git clone https://github.com/iotaledger/kinesis.git -b branch-name
    ```
...
Iota supports the following API operations related to staking. You can find the source code in the [iota_system](https://github.com/iotaledger/kinesis/blob/main/crates/iota-framework/packages/iota-system/sources/iota_system.move) module.
