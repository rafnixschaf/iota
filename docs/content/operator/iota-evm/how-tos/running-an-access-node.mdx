...
You can follow the progress using `docker logs -f wasp`. If you chose to create a [full-archive node](#run-an-archive-node), this can take several minutes, maybe hours.
