...
Refer to the [Iota Indexer README](https://github.com/iotaledger/iota/tree/main/crates/iota-indexer) to run an indexer with a local or managed Postgres-compatible database.
