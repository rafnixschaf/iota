...
Following these actions, the protocol computes the total amount of stake as the sum of staked IOTA plus the storage fund. Call the share of user stake $\alpha$.
