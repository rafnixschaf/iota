		...
		items: [
			{
				type: 'link',
				label: 'dApp Kit',
				href: 'https://wiki.iota.org/references/ts-sdk/dapp-kit',
			},
			'references/rust-sdk',
			{
				type: 'link',
				label: 'TypeScript SDK',
				href: 'https://wiki.iota.org/references/ts-sdk/typescript',
			},
			{
				type: 'link',
				label: 'zkSend SDK',
				href: 'https://wiki.iota.org/references/ts-sdk/zksend',
			},
		],
	},
	{
