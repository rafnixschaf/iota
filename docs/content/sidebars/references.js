...
const references = [
	...
	},
	{
		...
		items: [
			'references/layer-2-smart-contracts/json-rpc-spec',
			{
				type: 'category',
				...
				items: [
					{
						type: 'autogenerated',
						dirName: 'references/layer-2-smart-contracts/magic-contract',
					},
				],
			},
			{
				...
				items: [
					{
						type: 'doc',
						label: 'Overview',
						id: 'references/layer-2-smart-contracts/core-contracts/overview',
					},
					{
						type: 'doc',
						label: 'root',
						id: 'references/layer-2-smart-contracts/core-contracts/root',
					},
					{
						type: 'doc',
						label: 'accounts',
						id: 'references/layer-2-smart-contracts/core-contracts/accounts',
					},
					{
						type: 'doc',
						label: 'blob',
						id: 'references/layer-2-smart-contracts/core-contracts/blob',
					},
					{
						type: 'doc',
						label: 'blocklog',
						id: 'references/layer-2-smart-contracts/core-contracts/blocklog',
					},
					{
						type: 'doc',
						label: 'governance',
						id: 'references/layer-2-smart-contracts/core-contracts/governance',
					},
					{
						type: 'doc',
						label: 'errors',
						id: 'references/layer-2-smart-contracts/core-contracts/errors',
					},
					{
						type: 'doc',
						label: 'EVM',
						id: 'references/layer-2-smart-contracts/core-contracts/evm',
					},
				],
			},
			{
				...
				items: [
					{
						type: 'autogenerated',
						dirName: 'references/layer-2-smart-contracts/iscutils',
					},
				],
			},
			{
				...
				id: 'references/layer-2-smart-contracts/wasm-lib-data-types',
			},
		],
	},
