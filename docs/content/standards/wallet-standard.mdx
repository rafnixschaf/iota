...
IOTA Foundation offers a bare bones scaffold for React-based applications called `@iota/dapp-kit`. See the [dApp Kit documentation](https://wiki.iota.org/references/ts-sdk/dapp-kit) for more informqtion.
