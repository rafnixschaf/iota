...
See the [coin module](https://github.com/iotaledger/iota/blob/main/crates/iota-framework/docs/iota-framework/coin.md) documentation for all available options when creating a coin-type token on Iota. 
