...
See the [coin module](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota-framework/coin.md) documentation for all available options when creating a coin-type token on Iota.
...
- [`coin` module rustdoc documentation](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota-framework/coin.md): Automated documentation output for the Iota framework `coin` module.
- [`token` module rustdoc documentation](https://github.com/iotaledger/iota/blob/develop/crates/iota-framework/docs/iota-framework/token.md): Automated documentation output for the Iota framework `token` module.
