module nft_marketplace::nft_marketplace {
    ...
    public fun rent<T: key + store>(
        ...
        assert!(kiosk_extension::is_installed<Marketplace>(borrower_kiosk), EExtensionNotInstalled);
    ...
    public fun reclaim<T: key + store>(
        ...
        assert!(kiosk_extension::is_installed<Marketplace>(renter_kiosk), EExtensionNotInstalled);
        ...
        if (transfer_policy.has_rule<T, LockRule>()) {
            kiosk_extension::lock<Marketplace, T>(
                Marketplace {},
                renter_kiosk,
                object,
                transfer_policy,
            ...
            kiosk_extension::place<Marketplace, T>(
                Marketplace {},
                renter_kiosk,
                object,
                transfer_policy,
